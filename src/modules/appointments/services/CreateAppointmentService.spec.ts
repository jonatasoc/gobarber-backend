...
describe('CreateAppointment', () => {
  ...
  it('should not be able to create an appointment at an ealier date', async () => {
    jest.spyOn(Date, 'now').mockImplementationOnce(() => {
      return new Date(2020, 4, 10, 12).getTime();
    });
  ...
  it('should not be able to create an appointment out of the availabe work hour range', async () => {
    jest.spyOn(Date, 'now').mockImplementationOnce(() => {
      return new Date(2020, 4, 10, 12).getTime();
    });
